...
import com.giao.wuhu.controller.WuserController;
import com.giao.wuhu.utils.WebSocketClient;
...
public class WebSocketService {
    ...
    public void onClose() {
        ...
        logger.info("----------------------------------------------------------------------------");
        logger.info(userName+"用户退出,当前在线人数为:" + getOnlineCount());
    }
    ...
    public void onError(Session session, Throwable error) {
        logger.error("用户错误:"+this.userName+",原因:"+error.getMessage());
